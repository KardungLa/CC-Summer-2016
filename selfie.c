...
// |  4 | type    | INT_T, INTSTAR_T, VOID_T, INTARRAY_T, INTSTARARRAY_T
...
void gr_variable(int offset) {
  ...
  createSymbolTableEntry(LOCAL_TABLE, identifier, lineNumber, VARIABLE, type, 0, offset - size, size);
